		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Configuración",
									"targetURL": "#usilconfiguracionportalreserva-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"usilconfiguracionportalreserva-display": {
								"semanticObject": "usilconfiguracionportalreserva",
								"action": "display",
								"description": "Aplicación para configuración del portal de reservas",
								"title": "Configuración",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=usilconfiguracionportalreserva",
									"url": sap.ui.require.toUrl("usilconfiguracionportalreserva")
								}
							}
						}
					}
